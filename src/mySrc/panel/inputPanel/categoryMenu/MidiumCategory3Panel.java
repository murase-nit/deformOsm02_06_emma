...
/**
 * カテゴリ選択ウインドウにおける"レジャーエンタメ"のパネル.
 * @author murase
 *
 */
public class MidiumCategory3Panel extends JPanel implements ActionListener{
	...
	public MidiumCategory3Panel(CategoryWindow aCategoryWindow){
		...
		for(int i=0; i<CategoryList.category1c2.length; i++){
			_category2CheckBoxArray.add(new JCheckBox(CategoryList.category1c2[i]));
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource() == _category2CheckBoxArray.get(0)){	// "すべて"の項目がチェックされた.
			...
			_categoryWindow.setTabTitle(3, checkedNum);
			return;
		}
